...
final class Colors {
    static let backgroundColor = UIColor.color(hex: 0x000000)
    ...
    static let gradientStart = UIColor.color(hex: 0xEAFFAB)
    static let gradientEnd = UIColor.color(hex: 0x9CCB0C)
}
