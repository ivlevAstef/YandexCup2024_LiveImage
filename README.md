...
Но пока не успел - лень, да и эта задача оценивается по балам низко - кажется нет смысла.
...
* 0.5 часа - просто тестировал, и исправлял мини косяки которые в ходе рефакторинга возникли.
